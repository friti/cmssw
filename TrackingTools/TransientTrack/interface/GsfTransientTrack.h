...
namespace reco {
  ...
  public:
    ...
    GsfTransientTrack( const GsfTrackRef & tk , const MagneticField* field, const edm::ESHandle<GlobalTrackingGeometry>& trackingGeometry, const math::XYZVector& momVal, const int chVal);
