...
l1tPFClustersFromGCTPFClusters = cms.EDProducer("PFClusterProducerFromGCTPFClusters",
    # input GCTPFClusters
...
phase2_hgcalV10.toModify(l1tPFClustersFromGCTPFClusters,
...
phase2_hgcalV11.toModify(l1tPFClustersFromGCTPFClusters,
    #corrector  = "", # In this setup, TP's are already calibrated correctly :-) 
